...
if __name__ == '__main__':
    ...
    s_folder = '/root/BiTr-Unet/postprocess/output/submission/BiTrUnet2022-10-11'
    g_folder = '/root/autodl-tmp/data/BraTS2021_ValidationData'
    patient_names_file = '/root/autodl-tmp/data/official_valid.txt'
